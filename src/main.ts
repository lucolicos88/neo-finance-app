...
import {
  ...
  iniciarImportacaoContasPagasTxt,
  getSheetData,
  toggleCentroCusto,
...
const DEPLOY_LABEL = 'v129 - ajustar margens impressao';
...
global.iniciarImportacaoContasPagasTxt = wrapApi('iniciarImportacaoContasPagasTxt', iniciarImportacaoContasPagasTxt);
